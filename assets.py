...
planet_description =[
"""Mercury is the planet closest to the sun. Due to its short 88 day orbit Mercury is on average every planet's closest neighbor. Mercury is rocky and has a very thin atmosphere causing it's temperature to fluctuate greatly.
""",
...
""",
"""Mars is the fourth planet in the solar system. Nicknamed "The Red Planet" mars is known dusty orange red color. Next to Earth Mars is the most hospitable planet in the solar system for life. Manned missions to Mars are likely to occur in the future.
""",
